      ...
      <div className="mt-3">
        ...
        >
          ...
          <div className="flex items-center justify-around gap-2">
            ...
            <button
              type="submit"
              className="flex w-24 justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm/6 font-medium text-white shadow-xs hover:bg-blue-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 cursor-pointer"
            >
              Continuar
            </button>
          </div>
