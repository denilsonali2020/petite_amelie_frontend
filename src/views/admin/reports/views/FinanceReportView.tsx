...
export default function FinanceReportView() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6 bg-gray-50 min-h-screen font-sans">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">
              Reporte general de ingresos y costos.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
          ...
          <button
            ...
            className="flex items-center justify-center bg-pink-600 hover:bg-pink-700 text-white text-sm font-bold rounded-xl px-5 py-2.5 shadow-sm transition-all flex-1 lg:flex-none cursor-pointer"
          >
      ...
      <FinanceCards startDate={appliedStart} endDate={appliedEnd} />
    </div>
  );
}