                  ...
                  <table className="min-w-full divide-y divide-gray-100">
                    <thead className="bg-gray-50/50">
                      <tr>
                        ...
                        {/* 1. NUEVA COLUMNA DE DESCRIPCIÓN */}
                        <th className="px-3 py-4 text-left text-xs font-bold uppercase tracking-widest text-gray-400">
                          Descripción
                        </th>
                        <th className="px-3 py-4 text-left text-xs font-bold uppercase tracking-widest text-gray-400">
                      ...
                      {data.children && data.children.length > 0 ? (
                        data.children.map((subCategory) => (
                          ...
                          >
                            ...
                            {/* 2. CELDA DE DESCRIPCIÓN CON TRUNCADO AUTOMÁTICO */}
                        ...
                        <tr>
                          {/* 3. ACTUALIZADO COLSPAN DE 4 A 5 PARA CUBRIR TODA LA TABLA */}
                          <td colSpan={5} className="py-20 text-center">
                            ...
                            <p className="mt-1 text-xs text-gray-400 font-light italic">
                              Empieza agregando una subcategoría a esta
                              colección.
                            </p>
                          </td>
                        </tr>
